...
namespace ConAndInv
{
    ...
    public static class Summa
    {
        ...
        /// </summary>
        public static StringBuilder Пропись(decimal сумма, Currenc валюта, StringBuilder result)
        {
        ...
        /// Записывает пропись суммы в заданной валюте в <paramref name="result"/> строчными буквами.
        /// </summary>
        public static StringBuilder Пропись(double сумма, Currenc валюта, StringBuilder result)
        {
        ...
        private static StringBuilder ДобавитьКопейки(uint дробная, Currenc валюта, StringBuilder result)
        {
            result.Append(' ');
        ...
        /// <see cref="Summa.Пропись (decimal, Currenc)"/>.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        public static string Пропись(decimal n, Currenc валюта)
        {
            return Число.ApplyCaps(Пропись(n, валюта, new StringBuilder()), Case.Нет);
        }

        /// <summary>
        /// Возвращает пропись заданной суммы.
        /// </summary>
        public static string Пропись(decimal n, Currenc валюта, Case заглавные)
        {
        ...
        /// Возвращает пропись заданной суммы строчными буквами.
        /// </summary>
        public static string Пропись(double n, Currenc валюта)
        {
            return Число.ApplyCaps(Пропись(n, валюта, new StringBuilder()), Case.Нет);
        }
        ...
        /// Возвращает пропись заданной суммы.
        /// </summary>
        public static string Пропись(double n, Currenc валюта, Case заглавные)
        {
            return Число.ApplyCaps(Пропись(n, валюта, new StringBuilder()), заглавные);
        }
    }
    ...
    public static class Число
    {
        ...
        {
            return Пропись(число, еи, Case.Нет);
        }

        /// <summary>
        /// Возвращает пропись числа.
        /// </summary>
        public static string Пропись(decimal число, IЕдиницаИзмерения еи, Case заглавные)
        {
        ...
        /// Возвращает пропись числа.
        /// </summary>
        public static string Пропись(double число, IЕдиницаИзмерения еи, Case заглавные)
        {
            return ApplyCaps(Пропись(число, еи, new StringBuilder()), заглавные);
        }
        ...
        /// Возвращает пропись числа.
        /// </summary>
        public static string Пропись(ulong число, IЕдиницаИзмерения еи, Case заглавные)
        {
            return ApplyCaps(Пропись(число, еи, new StringBuilder()), заглавные);
        }
        ...
        /// Возвращает пропись числа.
        /// </summary>
        public static string Пропись(uint число, IЕдиницаИзмерения еи, Case заглавные)
        {
            return ApplyCaps(Пропись(число, еи, new StringBuilder()), заглавные);
        }

        internal static string ApplyCaps(StringBuilder sb, Case заглавные)
        {
    ...
    public abstract class Case
    {
        ...
        public static readonly Case ВСЕ = new _ВСЕ();
        public static readonly Case Нет = new _Нет();
        public static readonly Case Первая = new _Первая();
    }
    ...
    {
        /// <summary> </summary>
        public Currenc(IЕдиницаИзмерения основная, IЕдиницаИзмерения дробная)
        {
        ...
        public static readonly Currenc Евро = new Currenc(
            new ЕдиницаИзмерения(РодЧисло.Мужской, "евро", "евро", "евро"),
            new ЕдиницаИзмерения(РодЧисло.Мужской, "цент", "цента", "центов"));

        public static readonly Currenc Сум = new Currenc(
           new ЕдиницаИзмерения(РодЧисло.Мужской, "сум", "сум", "сум"),
        ...
        {
            return Summa.Пропись(сумма, this);
        }
        ...
        /// </summary>
        public string Пропись(decimal сумма, Case заглавные)
        {
            return Summa.Пропись(сумма, this, заглавные);
        }

        /// <summary>
        /// Возвращает пропись суммы.
        /// </summary>
        public string Пропись(double сумма, Case заглавные)
        {
            return Summa.Пропись(сумма, this, заглавные);
        }
    }
